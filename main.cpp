...
#include "Console.h" //for clrscr(), getch(), kbhit() "console function"
...
class Ping_Pong{
	public:
		...
		void draw_layout(){
			clrscr(); // first clearing the screen to remove prev timestep
			...
			for(int i=0; i<height; i++){ // to traverse along height
				for(int j=0; j<width; j++){ // to traverse along width
					...
					if (j==0) cout << "||"; // left wall element
					
					if(ball->x == j && ball->y == i) cout << "O"; // printing ball at its
																// position
					// printing player_1 blade (length=4)
					else if(player_1->x == j && player_1->y == i) cout << "I";
					else if(player_1->x == j && player_1->y + 1 == i) cout << "I";
					else if(player_1->x == j && player_1->y + 2 == i) cout << "I";
					else if(player_1->x == j && player_1->y + 3 == i) cout << "I";
					
					// printing player_2 blade (length=4)
					else if(player_2->x == j && player_2->y == i) cout << "I";
					else if(player_2->x == j && player_2->y + 1 == i) cout << "I";
					else if(player_2->x == j && player_2->y + 2 == i) cout << "I";
					else if(player_2->x == j && player_2->y + 3 == i) cout << "I";
					
					
					else cout << " "; // rest of the area is blank
					
					if (j==width-1) cout << "|"; // right wall element
...
// driver function
int main(){
	Ping_Pong game(55, 20); // instanciating game
